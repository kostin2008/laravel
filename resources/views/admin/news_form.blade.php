...
<div class="row justify-content-center">
    <form method="POST"
        action="@if(isset($news->id)) {{ route('news.update', $news) }} @else {{ route('news.store') }} @endif"
        class="mt-5 border p-2 col col-md-6" enctype="multipart/form-data">
        @csrf
        @if (isset($news->id))
        @method('PUT')
        @endif
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <select name="category_id" id="category_id" class="form-control">
                    ...
                    <option @if($item->id == ($news->category_id ?? old('category_id') )) selected @endif
        ...
        <div class="form-group row">
            <div class="col-md-6 offset-md-4">
                <div class="form-check">
                    <input @if(old('isPrivate') || ($news->isPrivate ?? '') ) checked @endif class="form-check-input"
                    type="checkbox" name="isPrivate" id="isPrivate" value="1" {{ old('isPrivate') ? 'checked' : '' }}>
