...
@section('content')
    ...
    <form method="POST" action="{{ route('news.update' , $news->id) }}" class="mt-5" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <textarea id="text" class="form-control" name="text">{{ $news->text }}</textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="col-md-6 offset-md-4">
                <div class="form-check">
                    <input @if($news->isPrivate) checked @endif class="form-check-input" type="checkbox" name="isPrivate" id="isPrivate" value="1" {{ old('isPrivate') ? 'checked' : '' }}>
